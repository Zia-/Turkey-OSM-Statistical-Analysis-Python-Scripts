...
connection = psycopg2.connect("host='localhost' dbname='zia_osmdegree_turkeyplanet2004-2015' user='postgres' password='zia123'")
cursor1 = connection.cursor()

with open('/home/administrator/zia/NewTurkeySlices/Edge/osmdegree/osmdegree_calculation_12345.csv', 'wb') as f:
	writer = csv.writer(f, delimiter= ',')
	data = ['seasons_in_number', 'seasons_in_text', 'degree', 'frequency_addedaccumulated']
